...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2023 at 07:15 PM
...
(1, 'Lòng mẹ', 'Lòng mẹ', 2, 'Và mẹ ơi đừng khóc nhé! Cả đời này mẹ đã khóc nhiều lắm rồi, hãy cười lên vì con đã trưởng thành! Con sẽ lại về dậy sớm nấu cơm cho mẹ, nấu nước cho mẹ tắm như ngày xưa. “Dù cho vai nắng nhưng lòng thương chẳng nhạt màu, vẫn mơ quay về vui vầy dưới bóng mẹ yêu”', '', 1, '2012-07-23 00:00:00', 'avatar-facebook-mac-dinh-19.jpg'),
...
(21, 'sadsa', 'cxzcxzc', 1, 'dsadsa', 'safsa', 1, '2023-02-23 16:43:55', 'avatar-vo-danh-50.jpg');
...
(8, 'Tâm tình', NULL),
(10, 'dsadsa', 'avatar-facebook-mac-dinh-19.jpg');
...
--
ALTER TABLE `theloai`
  MODIFY `ma_tloai` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
